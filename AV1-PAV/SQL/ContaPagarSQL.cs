...
namespace AV1_PAV.SQL
{
    class ContaPagarSQL
    {
        public static List<ContaPagar> BuscarMultiplos(String coluna, String nome)
        {
            List<ContaPagar> Lista = new();
            String SQL = "SELECT * FROM ContaPagar WHERE " + coluna + " LIKE \"%" + nome + "%\"";
